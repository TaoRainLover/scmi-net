...
from utils.utils import create_processor, prepare_example, text_preprocessing
from transformers import AutoTokenizer
from torch.nn.utils.rnn import pad_sequence

warnings.filterwarnings("ignore")
# path_roberta_base = '/root/autodl-tmp/MMER/pretained_model/roberta-base'
...
class IEMOCAPDataset(object):
    ...
    def __getitem__(self, index):
        audio_path, bert_path, bert_text, label, _ = self.data_list[index]
...
def collate(sample_list):
    ...
    batch_text = tokenizer(batch_bert_text, padding=True, truncation=True, return_tensors="pt")  # padding到batch中最长句的长度
